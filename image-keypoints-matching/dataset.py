...
class SigmaPascalVOCKeypoints(InMemoryDataset):
    ...
    def __init__(self, root, category, train=True, transform=None,
        ...
        super(SigmaPascalVOCKeypoints, self).__init__(root, transform,
    ...
    def process(self):
        ...
        vgg16 = models.vgg16_bn(pretrained=True).to(self.device)
        vgg16.eval()
